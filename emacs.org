...
Note that mu needs to be installed on your machine for this to work
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq message-send-mail-function 'smtpmail-send-it
      ...
      smtpmail-default-smtp-server "smtp.dvorsak.fr"
      smtpmail-smtp-server "smtp.dvorsak.fr")
...
#+BEGIN_SRC emacs-lisp
  (defvar mu4e-view-actions
    '(("capture message" . mu4e-action-capture-message)
      ...
      ("git apply mbox" . mu4e-action-git-apply-mbox)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
    ...
    (require 'helm-circe)
      ...
      (setq tracking-ignored-buffers '("#ansible" "#python" "mesos" "clojure" "leiningen" "trisquel" "emacs" "lisp"))
